...
import { refreshStatus } from './modules/checkbox';
import { refreshDescriptions } from './modules/description';

let input = getElement('.input-task');
let listContainer = getElement('.container-list');
let removeCompletedTasks = getElement('.btn-clear');
let removeAllIcon = getElement('.refresh-icon');
